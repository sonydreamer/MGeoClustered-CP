...
class MSENet_RegressorAdapter_sony(RegressorAdapter):
    def __init__(self, model, device, fit_params=None):
        super(MSENet_RegressorAdapter_sony, self).__init__(model, fit_params)
        self.model = model
        self.device = device
